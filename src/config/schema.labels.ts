...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.visual": "Visual Tool",
  "tools.visual.enabled": "Enable Visual Tool",
  "tools.visual.model": "Visual Model Override",
  "tools.visual.maxLoopCount": "Visual Max Loop Count",
  "tools.visual.loopIntervalInMs": "Visual Loop Interval (ms)",
  "tools.visual.context.maxImages": "Visual Context Max Images",
  "tools.visual.retry.model": "Visual Model Retry Count",
  "tools.visual.retry.screenshot": "Visual Screenshot Retry Count",
  "tools.visual.retry.execute": "Visual Execute Retry Count",
  "tools.visual.targets.browser": "Visual Browser Target Enabled",
  "tools.visual.targets.desktop": "Visual Desktop Target Enabled",
  "tools.visual.safety.requireApprovalActions": "Visual Approval-required Actions",
  "tools.visual.data.screenshotUploadPolicy": "Visual Screenshot Upload Policy",
